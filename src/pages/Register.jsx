...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(
        `Welcome to Cartify, ${form.name.trim().split(' ')[0]}! ✨`,
        'success'
      );
      navigate('/products');
    } catch (err) {
  ...
  /* Shared input focus/blur handlers for dark glass inputs */
  const inputFocus = (e) => {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="fixed top-1/2 left-1/2 w-80 h-80 rounded-full pointer-events-none"
        style={{
          background:
